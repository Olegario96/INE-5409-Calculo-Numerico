...
[erro_interpolador_polinomial erro_index] = max(abs(y_aprox_interpolador - y_exato))
...
[erro_maclauren erro_index] = max(abs(y_aprox_maclauren - y_exato))
...
[erro_tchebyshev erro_index] = max(abs(y_aprox_tchebyshev - y_exato))
...
"Erro maximo de Pade"
[erro_pade erro_index] = max(abs(y_exato - y_pade))
